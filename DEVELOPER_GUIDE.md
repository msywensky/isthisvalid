...
**CI:** Every PR targeting `main` automatically runs the GitHub Actions workflow (`.github/workflows/ci.yml`): type-check → tests → build. The PR cannot be merged until all three pass. `npm run build` and `npm test` locally before pushing is still good practice — it gives you faster feedback than waiting for CI.

### Known Issues & Technical Debt

| Issue                                               | Severity   | Notes                                                                                                                                                                                                                                       |
| --------------------------------------------------- | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ~~No CI/CD pipeline~~ ✅ Resolved                   | ~~Medium~~ | GitHub Actions CI workflow added (`.github/workflows/ci.yml`): type-check → tests → build runs on every PR. Required status check gates merges to `main`.                                                                                   |
