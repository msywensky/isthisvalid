...
export default function QrFAQ() {
  return (
    <section className="w-full max-w-xl">
      <details className="group/section rounded-2xl border border-zinc-800 bg-zinc-900/50 open:border-cyan-500/20 transition-colors duration-150">
        ...
        <div className="space-y-2 px-2 pb-3 pt-1">
          {QR_FAQ_DATA.map(({ question, answer }) => (
            <details
              key={question}
              className="group rounded-xl border border-zinc-800 bg-zinc-900/50 open:border-cyan-500/30 open:bg-zinc-900 transition-colors duration-150"
            >
