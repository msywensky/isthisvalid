/**
 * Static NANP area-code → US state (or territory) mapping.
 *
 * Source: North American Numbering Plan Administration (NANPA).
 * Coverage: all active US area codes as of early 2026.
 *
 * Purposely limited to US area codes — this function returns null for
 * non-US numbers and for any area code not in this table.
 *
